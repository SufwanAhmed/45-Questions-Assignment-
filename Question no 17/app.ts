...
console.log(`Sorry ${Guest[5]} you are not invited for a dinner!!`);
Guest.pop();
console.log(Guest);
console.log(`Sorry ${Guest[4]} you are not invited for a dinner!!`);
Guest.pop();
console.log(Guest);
console.log(`Sorry ${Guest[3]} you are not invited for a dinner!!`);
Guest.pop();
console.log(Guest);
console.log(`Sorry ${Guest[2]} you are not invited for a dinner!!`);
Guest.pop();
console.log(Guest);
console.log(`${Guest[1]},${Guest[0]} you are still invited for a dinner!!`);
Guest.pop();
console.log(Guest);
Guest.pop();
console.log(Guest);
